...
//
//     final videoByartist = videoByartistFromJson(jsonString);

import 'dart:convert';

VideoByartist videoByartistFromJson(String str) => VideoByartist.fromJson(json.decode(str));

String videoByartistToJson(VideoByartist data) => json.encode(data.toJson());
...
class VideoByartist {
    ...
    factory VideoByartist.fromJson(Map<String, dynamic> json) => VideoByartist(
        status: json["status"],
