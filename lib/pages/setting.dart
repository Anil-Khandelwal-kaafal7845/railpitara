...
class SettingState extends State<Setting> {
  ...
  void trackMoEngageEventOnce() {
    ...
    Singular.eventWithArgs('Setting_screen_view', screenViewEvent);


    final properties = MoEProperties()
      ..addAttribute('screen_name', 'Setting_screen_view')
      ..addAttribute('user_id', Constant.userID.toString())
      ..addAttribute('timestamp', DateTime.now().toIso8601String());
    // Optional delay
    Future.delayed(Duration(seconds: 2), () {
      MoEngageService.instance.trackEvent('Setting_screen_view', properties);
      // moEngagePlugin();
    });
  }
